...
// create default collection
func createDefaultCollection(ctx context.Context, t *testing.T, mc *base.MilvusClient, autoID bool, enableDynamicField bool,
	opts ...client.CreateCollectionOption) string {
	t.Helper()

	// prepare schema
	collName := common.GenRandomString(6)
	fields := common.GenDefaultFields(autoID)
	schema := common.GenSchema(collName, autoID, fields, common.WithEnableDynamicField(enableDynamicField))
...
func createCollectionWithDataIndex(ctx context.Context, t *testing.T, mc *base.MilvusClient, autoID bool, enableDynamicField bool,
	withIndex bool, opts ...client.CreateCollectionOption) (string, entity.Column) {
	// collection
	collName := createDefaultCollection(ctx, t, mc, autoID, enableDynamicField, opts...)
